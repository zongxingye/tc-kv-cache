...
func init() {
	flag.StringVar(&global_mata.HttpAddr, "http_addr", "0.0.0.0:8080", "http listen addr")
...
func main()  {
	...
	go log.Fatal(fasthttp2.ListenAndServe(global_mata.HttpAddr, server.Router.Handler))
...
//	// 解析参数
//	flag.Parse()
//	if global_mata.HttpAddr == "" || raftAddr == "" || raftId == "" || raftCluster == "" {
...
//	//		//fmt.Println(myraft.GetLeaderIp(myRaft))
//	//		//fmt.Printf("%+v",global_mata.AddrMap)
//	//	}
//	//}()
